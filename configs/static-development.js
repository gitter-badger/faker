...
// bootstrap
styles.add(config.hosts.static + 'lib/bootstrap/dist/css/bootstrap.min.css')
	.add(config.hosts.static + 'lib/bootstrap/dist/css/bootstrap-theme.min.css');
...
scripts.add(config.hosts.static + 'lib/angular/angular.min.js')
	.add(config.hosts.static + 'lib/angular-route/angular-route.min.js')
	.add(config.hosts.static + 'lib/angular-resource/angular-resource.min.js')
	.add(config.hosts.static + 'lib/angular-cookies/angular-cookies.min.js');
