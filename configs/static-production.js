...
// bootstrap
styles.add('http://cdn.bootcss.com/bootstrap/3.2.0/css/bootstrap.min.css').add('http://cdn.bootcss.com/bootstrap/3.2.0/css/bootstrap-theme.min.css');
...
scripts.add('http://cdn.bootcss.com/angular.js/1.2.16/angular.min.js').add('http://cdn.bootcss.com/angular.js/1.2.16/angular-route.min.js').add('http://cdn.bootcss.com/angular.js/1.2.16/angular-resource.min.js').add('http://cdn.bootcss.com/angular.js/1.2.16/angular-cookies.min.js');
